 ...
 *
 * Transforms:
 *   /img/foo.png → /bmad-module-creative-intelligence-suite/img/foo.png (when base is /bmad-module-creative-intelligence-suite/)
 *   /llms.txt → /bmad-module-creative-intelligence-suite/llms.txt
 *
 ...
 * @param {string} options.base - The base path to prepend (e.g., '/bmad-module-creative-intelligence-suite/')
