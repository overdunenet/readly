...
2. 마일스톤 기한 확인
   - 기한 7일 이내 마일스톤이 있으면: "Sprint 1 마감이 N일 남았습니다" + 해당 마일스톤의 미완료 태스크 우선 추천
...
리스크
  [높음] Sprint 1에 미완료 태스크 2개 (기한 3주 내)
  [중간] #9 칸반 보드가 3일째 진행 중 — 블로커 있는지 확인 필요
```
