...
| UI 컴포넌트 설계                  | `designer`                           | `React/SKILL.md`                      |
| 스펙/기획 문서 검증               | `director`                           | `Director/SKILL.md`                   |
| Plan 품질 검증                    | `plan-verifier`                      | -                                     |
| PM 기획 (PRD/CIS/Feature 설계)    | `pm-planner`                         | `planning/SKILL.md`                   |
| 태스크 실행 관리 (추천/현황/완료) | `gpm-pm`                             | `gpm/SKILL.md`                        |
...
- Main은 동일 파일을 수정하는 agent를 순차적으로만 실행한다
...
- Subagent는 동일 접근의 재시도를 최대 2회까지만 수행한다
