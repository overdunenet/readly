...
| PM 기획 워크플로우 | /pm 커맨드로 Milestone/Feature/Issue 관리 및 CIS 워크플로우 실행 | 기획부터 이슈 관리까지 대화형으로 처리 |
...
4. /pm 입력 → PM Planner Agent가 대화형으로 기획 워크플로우 실행 (PRD 작성, CIS 워크플로우)

## 관련 Codebase Context

- [context-handoff.md](../codebase/context-handoff.md)
- [prompt-structuring.md](../codebase/prompt-structuring.md)
- [pm-planner-agent.md](../codebase/pm-planner-agent.md)
