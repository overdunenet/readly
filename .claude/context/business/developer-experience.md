...
| 기능 | 설명 | 사용자 관점 |
|------|------|------------|
| 코드 리뷰 자동화 | PR 생성 시 Claude Code가 자동 코드 리뷰 수행 | 수동 리뷰 부담 감소 |
| Context 자동 생성 | PR diff 분석으로 context 문서 자동 생성 | 문서화 부담 제거 |
| 무한 루프 방지 | context 문서 변경은 CI 트리거에서 제외 | 불필요한 CI 실행 방지 |

## 관련 Codebase Context

- [context-handoff.md](../codebase/context-handoff.md)
- [prompt-structuring.md](../codebase/prompt-structuring.md)
- [ci-workflows.md](../codebase/ci-workflows.md)
