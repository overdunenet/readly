...
# API - Database
DB_POSTGRES_HOST=...
DB_POSTGRES_RO_HOST=...       # Read-Only 호스트 (옵션, 미설정 시 HOST 사용)
DB_POSTGRES_USERNAME=...
DB_POSTGRES_PASSWORD=...

# API - JWT (Backoffice/User 각각 Access/Refresh 분리)
JWT_BACKOFFICE_ACCESS_SECRET=...
JWT_BACKOFFICE_REFRESH_SECRET=...
